/**
 * The oringinal client library was implemented in C and has quite some C
 * components left. We provide a common audio output C api that is using the
 * AudioTools C++ library.
 */
#pragma once
#include "stdbool.h"
#include "stddef.h"
